...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			path.set ("assets/bottom.png", "assets/bottom.png");
			type.set ("assets/bottom.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/bottom_small.png", "assets/bottom_small.png");
			type.set ("assets/bottom_small.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/top.png", "assets/top.png");
			type.set ("assets/top.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/top_small.png", "assets/top_small.png");
			type.set ("assets/top_small.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("MyDB.cdb", "MyDB.cdb");
			type.set ("MyDB.cdb", Reflect.field (AssetType, "text".toUpperCase ()));
