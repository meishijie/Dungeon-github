...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "BlendModes", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "BlendModes";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "BlendModes", null, { width: 300, height: 200 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 300, height: 200 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 300, 200, "null");
		#end
		#else
		create ();
		#end
