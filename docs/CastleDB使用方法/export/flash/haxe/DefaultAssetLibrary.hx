...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/bottom.png", __ASSET__assets_bottom_png);
		type.set ("assets/bottom.png", AssetType.IMAGE);
		className.set ("assets/bottom_small.png", __ASSET__assets_bottom_small_png);
		type.set ("assets/bottom_small.png", AssetType.IMAGE);
		className.set ("assets/top.png", __ASSET__assets_top_png);
		type.set ("assets/top.png", AssetType.IMAGE);
		className.set ("assets/top_small.png", __ASSET__assets_top_small_png);
		type.set ("assets/top_small.png", AssetType.IMAGE);
		...
		var id;
		id = "assets/bottom.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/bottom_small.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_bottom_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_bottom_small_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_top_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_top_small_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/bottom.png") #if display private #end class __ASSET__assets_bottom_png extends lime.graphics.Image {}
@:image("assets/bottom_small.png") #if display private #end class __ASSET__assets_bottom_small_png extends lime.graphics.Image {}
@:image("assets/top.png") #if display private #end class __ASSET__assets_top_png extends lime.graphics.Image {}
@:image("assets/top_small.png") #if display private #end class __ASSET__assets_top_small_png extends lime.graphics.Image {}
