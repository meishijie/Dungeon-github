...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "RogueLike", "com.example.myapp", "1.0.1");
		...
		telemetryConfig.app_name = "FlixelRL";
		#end
		...
		flash.Lib.create (function () {
			...
			(null == 4 ? flash.Lib.HW_AA_HIRES : 0) |
			(null == 2 ? flash.Lib.HW_AA : 0),
			"FlixelRL",
			null
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "FlixelRL", null, { width: 852, height: 480 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 852, height: 480 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 852, 480, "null");
		#end
		#else
		create ();
		#end
