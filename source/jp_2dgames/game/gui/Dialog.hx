...
class Dialog extends FlxGroup {
  // ダイアログの種類 对话框种类
  public static inline var OK:Int = 0; // OK对话框
  public static inline var YESNO:Int = 1; // Yes/No对话框
  public static inline var SELECT2:Int = 2; // 2択对话框
  public static inline var SELECT3:Int = 3; // 3択对话框
